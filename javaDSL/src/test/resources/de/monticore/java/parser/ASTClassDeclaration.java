...
de.monticore.ast.ASTCNode implements de.monticore.java.javadsl._ast.ASTTypeDeclaration,  ASTJavaDSLNode {
  /* generated by template ast.Attribute*/
   protected  String name;

  /* generated by template ast.Attribute*/
   protected  Optional<de.monticore.types.typeparameters._ast.ASTTypeParameters> typeParameters = Optional.empty();

  /* generated by template ast.Attribute*/
   protected  Optional<de.monticore.types.mcbasictypes._ast.ASTMCType> superClass = Optional.empty();

  /* generated by template ast.Attribute*/
   protected  de.monticore.types.mccollectiontypes._ast.ASTMCListType implementedInterfaces = de.monticore.types.types._ast.TypesNodeFactory.createASTTypeList();

  /* generated by template ast.Attribute*/
   protected  de.monticore.java.javadsl._ast.ASTClassBody classBody;

  /* generated by template ast.Attribute*/
   public  Optional<? extends ISymbol> symbol = Optional.empty();

  /* generated by template ast.Attribute*/
   public  Optional<? extends IScope> enclosingScope = Optional.empty();
  ...
  { // empty body
   ...
   protected  ASTClassDeclaration (/* generated by template ast.ConstructorParametersDeclaration*/
     String name
    ,
     de.monticore.types.typeparameters._ast.ASTTypeParameters typeParameters
    ,
     de.monticore.types.mcbasictypes._ast.ASTMCType superClass
    ,
     de.monticore.types.mccollectiontypes._ast.ASTMCListType implementedInterfaces
    ,
     de.monticore.java.javadsl._ast.ASTClassBody classBody
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(de.monticore.java.javadsl._visitor.JavaDSLVisitor2 visitor)
   ...
   public  boolean equalsWithComments(Object o)
    ...
    if (get_PreComments().size() == comp.get_PreComments().size()) {
      de.monticore.ast.Comment one = get_PreComments().iterator();
      de.monticore.ast.Comment two = comp.get_PreComments().iterator();
      while (one.hasNext()){
    ...
    if (get_PostComments().size() == comp.get_PostComments().size()) {
      de.monticore.ast.Comment one = get_PostComments().iterator();
      de.monticore.ast.Comment two = comp.get_PostComments().iterator();
      while (one.hasNext()){
        if (!one.next().equals(two.next())) {
          return false;
        }
  ...
  /* generated by template ast.ClassMethod*/
  public  de.monticore.ast.ASTNode get_Children(){
    de.monticore.ast.ASTNode result =  new de.monticore.ast.ASTNode();
   ...
   public  ASTClassDeclaration deepClone(ASTClassDeclaration result)
    ...
    result.typeParameters = this.typeParameters.isPresent()? Optional.ofNullable((de.monticore.types.typeparameters._ast.ASTTypeParameters)this.typeParameters.get().deepClone()) : Optional.empty();
    ...
    if (this.classBody != null) {
      result.setClassBody((de.monticore.java.javadsl._ast.ASTClassBody) this.classBody.deepClone());
    }
    result.symbol = this.symbol.isPresent()? Optional.ofNullable((ISymbol)this.symbol.get()) : Optional.empty();
    result.enclosingScope = this.enclosingScope.isPresent()? Optional.ofNullable((IScope)this.enclosingScope.get()) : Optional.empty();
    return result;
   ...
   public  Optional<de.monticore.types.typeparameters._ast.ASTTypeParameters> getTypeParameters()
   ...
   public  Optional<de.monticore.types.mcbasictypes._ast.ASTMCType> getSuperClass()
   ...
   public  de.monticore.types.mccollectiontypes._ast.ASTMCListType getImplementedInterfaces()
   ...
   public  de.monticore.java.javadsl._ast.ASTClassBody getClassBody()
   ...
   public  Optional<? extends ISymbol> getSymbol()
   ...
   public  Optional<? extends IScope> getEnclosingScope()
   ...
   public  void setTypeParameters(de.monticore.types.typeparameters._ast.ASTTypeParameters typeParameters)
   ...
   public  void setSuperClass(de.monticore.types.mcbasictypes._ast.ASTMCType superClass)
   ...
   public  void setImplementedInterfaces(de.monticore.types.mccollectiontypes._ast.ASTMCListType implementedInterfaces)
   ...
   public  void setClassBody(de.monticore.java.javadsl._ast.ASTClassBody classBody)
 ...
 /**
  ...
  public static class Builder  {
    ...
    /* generated by template ast.BuilderAttribute*/
     protected  de.monticore.types.typeparameters._ast.ASTTypeParameters typeParameters;

    /* generated by template ast.BuilderAttribute*/
     protected  de.monticore.types.mcbasictypes._ast.ASTMCType superClass;
...
/* generated by template ast.AstBuilderAttributeSetter*/
    public Builder typeParameters(de.monticore.types.typeparameters._ast.ASTTypeParameters typeParameters) {
      this.typeParameters = typeParameters;
      return this;
    }
/* generated by template ast.AstBuilderAttributeSetter*/
    public Builder superClass(de.monticore.types.mcbasictypes._ast.ASTMCType superClass) {
      this.superClass = superClass;
      return this;
    }
/* generated by template ast.AstBuilderAttributeSetter*/
    public Builder implementedInterfaces(de.monticore.types.mccollectiontypes._ast.ASTMCListType implementedInterfaces) {
      this.implementedInterfaces = implementedInterfaces;
      return this;
    }
/* generated by template ast.AstBuilderAttributeSetter*/
    public Builder classBody(de.monticore.java.javadsl._ast.ASTClassBody classBody) {
      this.classBody = classBody;
      return this;
    }
