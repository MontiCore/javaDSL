 ...
 *  on 08.06.2016.
 */
public class MultiplicativeOpsValid implements JavaDSLASTExpressionCoCo {
  ...
  public void check(ASTExpression node) {
    if (JavaDSLHelper.rightAndLeftExpressionsValid(node) && node
        .multiplicativeOpIsPresent()) {
